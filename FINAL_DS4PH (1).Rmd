...
It is worth noting Tether is the only cryptocurrency with any noticable cyclical tendencies.
...
```{r}
# Reading in the data
btc_dat2 <- read.csv("coin_Bitcoin.csv")
```

```{r}
# Merging, reordering, and cleaning the data
btc_data = btc_dat2 %>% select(High, Low, Open, Close, Volume, Marketcap)
